...
public class Locatorpractice {
	...
	driver0.findElement(By.cssSelector("input[type='text']:nth-child(3)")).sendKeys("nairanu525@gmail.com");
	driver0.findElement(By.xpath("//form/input[3]")).sendKeys("95255554552");
	driver0.findElement(By.cssSelector(".reset-pwd-btn")).click();
	System.out.println(driver0.findElement(By.cssSelector("form p")).getText());
	...
	driver0.findElement(By.cssSelector("#inputUsername")).sendKeys("anusha");
	driver0.findElement(By.cssSelector("input[type*='pass']")).sendKeys("rahulshettyacademy");
	driver0.findElement(By.id("chkboxOne")).click();
	driver0.findElement(By.xpath("//button[contains(@class,'submit')]")).click();
