...
public class Locatorpractice3 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//driver0.navigate().back();
		System.out.println(driver0.findElement(By.xpath("//header/div/button[1]/following-sibling::button[1]")).getText());
		System.out.println(driver0.findElement(By.xpath("//header/div/button[1]/parent::div/parent::header")).getText());
